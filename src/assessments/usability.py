...
def check_ease_of_use(driver: WebDriver, url: str):
    ...
    try:
        ...
        login_button = driver.find_element(
            By.CSS_SELECTOR, "a.login-link, button.login-btn")
        if login_button:
...
def check_learnability(driver: WebDriver, url: str):
    ...
    try:
        ...
        help_button = driver.find_element(
            By.CSS_SELECTOR, "a.help-link, button.help-btn")
...
def check_operability(driver: WebDriver, url: str):
    ...
    try:
        ...
        course_button = driver.find_element(
            By.CSS_SELECTOR, "button.register-course-btn")
...
def check_user_error_protection(driver: WebDriver, url: str, protection_type: str):
    ...
    results = {
        "test_name": f"사용자 오류 보호 테스트 ({protection_type})", "passed": False, "details": ""}
        ...
        if protection_type == "password_confirmation":
            ...
            try:
                delete_button = driver.find_element(
                    By.CSS_SELECTOR, "button.delete-data-btn")
                delete_button.click()
                time.sleep(1)
...
def check_content_search(driver: WebDriver, url: str):
    ...
    try:
        ...
        autocomplete_results = driver.find_elements(
            By.CSS_SELECTOR, ".autocomplete-result")
...
def check_continue_watching(driver: WebDriver, url: str):
    ...
    try:
        ...
        resume_message = driver.find_element(
            By.CSS_SELECTOR, ".resume-watching-message, button.resume-btn")
